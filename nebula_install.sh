...
if [ ! -d /tmp/metis_resources ]; then
    mkdir /tmp/metis_resources
fi
if [ -d /tmp/metis_resources ]; then
    git clone https://github.com/ddominet/METIS-cluster /tmp/metis_resources
fi
if [ ! -f /etc/nebula/nebula ]; then
    sudo cp /tmp/metis_resources/nebula /etc/nebula/
fi
if [ ! -f /etc/nebula/config.yaml ]; then
    sudo cp /tmp/metis_resources/config.yaml /etc/nebula/
fi
if [ ! -f /etc/nebula/ca.crt ]; then
    sudo cp /tmp/metis_resources/ca.crt /etc/nebula/
fi
...
if [ ! -f /etc/nebula/nebula-start.sh ]; then
    sudo cp /tmp/metis_resources/nebula-start.sh /etc/nebula
    sudo chmod +x /etc/nebula/nebula-start.sh
fi
if [ ! -f /etc/systemd/system/nebula-start.service ]; then
    sudo cp /tmp/metis_resources/nebula-start.service /etc/systemd/system/
